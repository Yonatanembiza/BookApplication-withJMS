...
public class BookController {
    ...
    public String addBook(@RequestBody Book book){
        String message = "The following book was added into the dB: ";
    ...
    public Book getBook(@PathVariable String isbn){
        ...
        String message = "The following book was fetched from the dB: ";
        jmsSender.sendMessage(message, book);
        return  book;
    }
    @GetMapping
    ...
    public String updateBook(@PathVariable String isbn, @RequestBody Book book){
        String message = "The updated book is: ";
        jmsSender.sendMessage(message, book);
    ...
    public String deleteBook(@PathVariable String isbn){
        Book book = bookService.getBook(isbn);
        String message = "The following book was deleted from the dB: ";
        jmsSender.sendMessage(message, book);
